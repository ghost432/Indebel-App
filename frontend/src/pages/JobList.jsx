...
const JobList = () => {
  ...
  const fetchFiltersData = async () => {
    try {
      ...
      setCompetences(competencesRes.data.data || []);
    } catch (error) {
  ...
  const fetchApplications = async () => {
    try {
      ...
      const jobIds = new Set(response.data.data.map(app => app.job_id))
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <Input
            type="text"
            placeholder="Rechercher une mission par mot-clé, compétence ou recruteur..."
            value={searchTerm}
