...
export default function EmployerCredits() {
  ...
  useEffect(() => {
    document.title = 'Mes Crédits - Recruteur - Indebel'
    fetchData()
  }, [])
    ...
    <div className="container-custom py-8 space-y-8 animate-fadeIn">
      ...
      <section className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#082151] via-[#0d2f6f] to-[#2A4DEF] p-8 text-white shadow-xl">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <h1 className="mt-3 text-3xl md:text-4xl font-black text-white">Gestion de mes Crédits (Recruteur)</h1>
            <p className="mt-2 text-white/80 max-w-xl text-sm md:text-base leading-relaxed">
              Publiez des offres, recevez des devis et entrez en contact direct avec les meilleurs prestataires vérifiés.
            </p>
          </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-black text-[#082151]">Tarification des actions (Recruteur)</h2>
            <p className="text-xs text-slate-500 font-semibold">Chaque publication ou déblocage de contact déduit les crédits correspondants.</p>
          </div>
        </div>
          ...
          <Card className="p-5 border border-slate-100 hover:border-[#2A4DEF]/30 transition-all hover:shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black bg-blue-100 text-[#082151] px-3 py-1 rounded-full">
                {settings.cout_demandes_devis} crédit{settings.cout_demandes_devis > 1 ? 's' : ''}
              </span>
            </div>
            <h3 className="font-bold text-[#082151] text-sm">Publier une Demande de Devis</h3>
            <p className="text-xs text-slate-500 mt-1">Publication d'un projet pour recevoir des devis.</p>
          </Card>
          ...
          <Card className="p-5 border border-slate-100 hover:border-[#2A4DEF]/30 transition-all hover:shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black bg-emerald-100 text-emerald-900 px-3 py-1 rounded-full">
                {settings.cout_missions_employer} crédit{settings.cout_missions_employer > 1 ? 's' : ''}
              </span>
            </div>
            <h3 className="font-bold text-[#082151] text-sm">Publier une Offre de Mission</h3>
            <p className="text-xs text-slate-500 mt-1">Mise en ligne d'une opportunité de mission.</p>
          </Card>
          ...
          <Card className="p-5 border border-slate-100 hover:border-[#2A4DEF]/30 transition-all hover:shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black bg-purple-100 text-purple-900 px-3 py-1 rounded-full">
                {settings.cout_devis_recus} crédit{settings.cout_devis_recus > 1 ? 's' : ''}
              </span>
            </div>
            <h3 className="font-bold text-[#082151] text-sm">Débloquer un Devis Reçu</h3>
            <p className="text-xs text-slate-500 mt-1">Accès aux détails et coordonnées du prestataire.</p>
          </Card>
          ...
          <Card className="p-5 border border-slate-100 hover:border-[#2A4DEF]/30 transition-all hover:shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black bg-amber-100 text-amber-900 px-3 py-1 rounded-full">
                {settings.cout_candidatures_recues} crédit{settings.cout_candidatures_recues > 1 ? 's' : ''}
              </span>
            </div>
            <h3 className="font-bold text-[#082151] text-sm">Débloquer une Candidature Reçue</h3>
            <p className="text-xs text-slate-500 mt-1">Consultation des coordonnées d'un candidat.</p>
          </Card>
          ...
          <Card className="p-5 border border-slate-100 hover:border-[#2A4DEF]/30 transition-all hover:shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black bg-indigo-100 text-indigo-900 px-3 py-1 rounded-full">
                {settings.cout_vues_freelancers} crédit{settings.cout_vues_freelancers > 1 ? 's' : ''}
              </span>
            </div>
            <h3 className="font-bold text-[#082151] text-sm">Annuaire des Prestataires</h3>
            <p className="text-xs text-slate-500 mt-1">Consultation de la liste et profils prestataires.</p>
          </Card>
          ...
          <Card className="p-5 border border-slate-100 hover:border-[#2A4DEF]/30 transition-all hover:shadow-md">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black bg-rose-100 text-rose-900 px-3 py-1 rounded-full">
                {settings.cout_documents_employer} crédit{settings.cout_documents_employer > 1 ? 's' : ''}
              </span>
            </div>
            <h3 className="font-bold text-[#082151] text-sm">Export de Documents</h3>
            <p className="text-xs text-slate-500 mt-1">Téléchargement et impression de factures.</p>
          </Card>
        </div>
      </section>
      ...
      <section className="space-y-4 pt-4">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-sm text-slate-500 mt-1">Sélectionnez le pack qui correspond le mieux à vos besoins.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto pt-2">
          ...
          <Card className="p-6 border border-slate-200 flex flex-col justify-between hover:border-[#2A4DEF] transition-all hover:shadow-lg rounded-[28px]">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Pour publier occasionnellement des besoins.</p>
          ...
          <Card className="!overflow-visible p-6 border-2 border-[#2A4DEF] bg-gradient-to-b from-blue-50/40 to-white flex flex-col justify-between shadow-xl relative rounded-[28px]">
            ...
            <div>
              <div className="flex justify-between items-center mb-4 mt-2">
                <span className="text-xs font-black uppercase tracking-wider text-[#2A4DEF]">Business</span>
                <Coins className="h-7 w-7 text-amber-500" />
              </div>
              <h3 className="text-xl font-black text-[#082151]">Pack 50 Crédits</h3>
              <p className="text-xs text-slate-500 mt-1">Pour les recruteurs gérant plusieurs chantiers/projets.</p>
          ...
          <Card className="p-6 border border-slate-200 flex flex-col justify-between hover:border-[#2A4DEF] transition-all hover:shadow-lg rounded-[28px]">
            <div>
              <div className="flex justify-between items-center mb-4">
                <span className="text-xs font-black uppercase tracking-wider text-purple-600">Entreprise</span>
                <Coins className="h-6 w-6 text-purple-500" />
              </div>
              <h3 className="text-xl font-black text-[#082151]">Pack 100 Crédits</h3>
              <p className="text-xs text-slate-500 mt-1">Pour un recrutement continu et intensif.</p>
      ...
      <section className="space-y-4 pt-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Toutes les opérations d'achats et de débits de votre compte.</p>
          </div>
        </div>
