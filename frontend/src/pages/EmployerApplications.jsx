  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Gérez toutes les candidatures à vos missions</p>
      </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <LabelBadge userId={app.freelancer_id} size="sm" />
                        </div>
                      </div>
                    ...
                    <div className="mb-3 p-3 bg-green-50 border-l-4 border-green-500 rounded">
                      <p className="text-sm text-green-900">
                        ...
                        <span className="font-semibold">{user?.denomination || 'votre recruteur'}</span>
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                      ...
                      <div className="flex items-center p-2 bg-gray-50 rounded">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-sm">{user?.denomination || 'Votre recruteur'}</p>
                        </div>
                      </div>
                    </div>
