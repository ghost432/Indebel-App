...
const RegisterEmployer = () => {
  ...
  useEffect(() => {
    ...
    document.title = `${stepTitles[step]} - Inscription Entreprise - Indebel`
  }, [step])
    ...
    try {
      ...
      try {
        ...
        if (checkResponse.data.exists) {
          ...
          toast.error('Cette entreprise possède déjà un compte sur la plateforme')
    ...
    if (step === 1) {
      ...
      if (manualMode && !bceVerified) {
        setFormData({
          ...formData,
          numero_bce: bceNumber,
          denomination: formData.denomination || 'Entreprise',
    ...
    return (
      <div className="mb-8">
        <div className="flex justify-between relative">
          ...
          <div 
            className="absolute top-5 left-[10%] h-1 transition-all duration-300 z-0 bg-[#2b4eef]" 
          ...
          {steps.map((label, index) => (
            <div key={index} className="flex flex-col items-center flex-1 relative z-10">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-medium transition-colors duration-300 ${
                step > index + 1 ? 'text-white bg-[#2b4eef]' :
                step === index + 1 ? 'text-white shadow-lg bg-[#2b4eef] shadow-[#2b4eef]/30 ring-4 ring-[#2b4eef]/20' :
        ...
        <div className="bg-white/90 backdrop-blur-xl p-10 rounded-[32px] shadow-[0_8px_40px_rgb(0,0,0,0.04)] shadow-[#2b4eef]/5 border border-slate-100">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <div className="h-20 w-20 bg-gradient-to-br from-[#2b4eef] to-[#1e38b3] rounded-full flex items-center justify-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Déjà un compte ?{' '}
              <Link to="/login" className="font-medium text-[#2b4eef] hover:text-[#2b4eef]">
                Se connecter
              </Link>
            </p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2b4eef]/20 focus:border-[#2b4eef] transition-all"
                    placeholder="0123456789"
                    disabled={bceVerified}
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    {checkingBce ? (
                      <Loader2 className="h-5 w-5 text-[#2b4eef] animate-spin" />
                    ) : bceVerified ? (
                      <CheckCircle2 className="h-5 w-5 text-[#10b981]" />
                    ) : bceNumber.length === 10 ? (
                      <Search className="h-5 w-5 text-[#2b4eef]" />
                    ) : (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2b4eef]"
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-[#2b4eef] to-[#1e38b3] hover:from-[#2b4eef] hover:to-[#1e38b3] text-white"
                  >
                    Suivant
                  </Button>
                </div>
                ...
                <div className="space-y-4">
                  {bceAlreadyExists ? (
                    ...
                    <div className="p-4 bg-[#ecfdf5] border border-[#a7f3d0] rounded-lg">
                      <p className="text-[#065f46] font-medium flex items-center mb-2">
                        <CheckCircle2 className="h-5 w-5 mr-2" />
                        Numéro BCE vérifié
                      </p>
            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2b4eef]/20 focus:border-[#2b4eef] transition-all"
                    placeholder="Jean"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="w-32 px-2 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2b4eef]"
                  >
                    {pays.map(p => (
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  type="button"
                  onClick={handleNextStep}
                  className="flex-1 bg-gradient-to-r from-[#2b4eef] to-[#1e38b3] hover:from-[#2b4eef] hover:to-[#1e38b3] text-white"
                >
                  Suivant
                </Button>
              </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent ${
                      emailValid === true ? 'border-[#10b981] focus:ring-[#10b981]' : 
                      emailValid === false ? 'border-red-500 focus:ring-red-500' : 
                      'border-gray-300 focus:ring-[#2b4eef]'
                    }`}
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="h-4 w-4 text-[#2b4eef] focus:ring-[#2b4eef] border-gray-300 rounded mt-1"
                  />
                  <label htmlFor="accepte_cgu" className="ml-2 block text-sm text-gray-700">
                    ...
                    <a 
                      ...
                      className="text-[#2b4eef] hover:text-[#2b4eef] underline"
                    >
