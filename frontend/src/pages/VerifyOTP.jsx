...
const VerifyOTP = () => {
  ...
  // Récupérer les données de l'inscription/login
  const { email, role, type, from } = location.state || {}
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (role === 'freelancer' && type === 'registration') {
          ...
          const redirectUrl = from || loginResult?.redirectUrl
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="text-sm text-gray-600 space-y-2 ml-4">
              ...
              <li>✅ Gagner la confiance des recruteurs</li>
