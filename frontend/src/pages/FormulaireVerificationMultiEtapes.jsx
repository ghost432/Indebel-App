        ...
        <div className={`border-2 border-dashed rounded-lg p-4 text-center transition-colors ${
          ...
          {formData[field] ? (
            ...
            <div>
              ...
              />
              <label htmlFor={field}>
                <span className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-primary-600 hover:bg-primary-700 cursor-pointer transition-colors">
                  Choisir un fichier
                </span>
              </label>
            </div>
