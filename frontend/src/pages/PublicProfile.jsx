  ...
  const fetchProfile = async (id) => {
    try {
      ...
      if (response.data && response.data.success && (response.data?.data || response.data)) {
        ...
        const name = (response.data?.data || response.data).role === 'employer' 
          ? (response.data?.data || response.data).denomination 
          : `${(response.data?.data || response.data).prenom || ''} ${(response.data?.data || response.data).nom || ''}`.trim()
