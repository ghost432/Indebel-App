...
const VerificationIdentite = () => {
  ...
  const fetchStatus = async () => {
    try {
      ...
      setStatut(response.data.data.statut || 'non_verifie')
      setDerniereDemande(response.data.data.derniere_demande)
    } catch (error) {
  ...
  if (statut === 'en_cours') {
    return (
      <div className="max-w-2xl mx-auto py-8">
        ...
        <Card className="text-center">
          <div className="mb-6 flex justify-center">
            <div className="w-48 h-48 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center animate-pulse">
  ...
  if (statut === 'refuse') {
    return (
      <div className="max-w-2xl mx-auto py-8">
        ...
        <Card className="text-center">
          <div className="mb-6 flex justify-center">
            <div className="w-48 h-48 bg-gradient-to-br from-red-100 to-red-200 rounded-full flex items-center justify-center">
