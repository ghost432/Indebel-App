...
const PublishMissionFixed = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
        <button onClick={() => navigate(isAdmin ? '/admin/publish-mission' : '/employer/publish-mission')} className="text-sm font-medium text-emerald-600 hover:text-emerald-800 flex items-center mb-4 transition-colors">
        ...
        <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight flex items-center gap-3">
          ...
          Mission Forfait Fixe
        </h1>
        <p className="text-lg text-slate-500 mt-3">Définissez un budget global et les objectifs de votre projet.</p>
      </div>
