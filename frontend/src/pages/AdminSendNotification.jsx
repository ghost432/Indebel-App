...
const AdminSendNotification = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const usersList = (response.data.data || []).filter(u => u.role !== 'admin')
      setUsers(usersList)
    } catch (error) {
  ...
  return (
    <div className="py-8">
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Envoyer une notification</h1>
        <p className="text-gray-600 mb-8">Envoyez des notifications aux utilisateurs de la plateforme</p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="employers">Recruteurs uniquement</option>
                      <option value="freelancers">Prestataires uniquement</option>
                        ...
                        {users.map(user => (
                          ...
                          >
                            ...
                            <div className="ml-3 flex-1">
                              ...
                              <p className="text-xs text-gray-500">{user.email} - {user.role === 'employer' ? 'Recruteur' : 'Prestataire'}</p>
                            </div>
                          </label>
                        ))}
                      </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">
                        ...
                        {formData.destinataires === 'employers' && 'Recruteurs'}
                        {formData.destinataires === 'freelancers' && 'Prestataires'}
