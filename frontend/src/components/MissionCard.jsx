          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center text-white/90 text-sm">
                ...
                <span>{mission.denomination || `${mission.prenom || ''} ${mission.nom || ''}`.trim() || 'Recruteur'}</span>
              </div>
            </div>
            <div className="flex flex-col items-end space-y-2">
              ...
              <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                ...
                mission.statut === 'en_cours' ? 'bg-yellow-100 text-yellow-700' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            {mission.nombre_independants && (
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-xs text-gray-600 font-medium">Prestataires recherchés</p>
          ...
          {user?.role === 'employer' && mission.statut === 'en_cours' && mission.freelancer_assigne && (
            <div className="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-green-600 font-medium">✅ Prestataire assigné</p>
                  <div className="flex items-center gap-2">
                    <p className="font-semibold text-gray-900">
                      {mission.freelancer_assigne.prenom} {mission.freelancer_assigne.nom}
                    </p>
                    <LabelBadge userId={mission.freelancer_assigne.id} size="sm" />
                  </div>
