      ...
      {step === 1 ? (
        <div className="space-y-4">
          ...
          <p className="text-slate-800 font-medium">
            Une évaluation aide les autres entreprises à faire leur choix et améliore
            la visibilité de l'indépendant sur la plateforme.
          </p>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg">
            <p className="text-sm text-slate-900 font-bold">
              Évaluation de l'indépendant <strong>{freelancer?.prenom} {freelancer?.nom}</strong>
            </p>
          </div>
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="recommandation" className="ml-2 block text-sm text-slate-900 font-semibold">
              Je recommande cet indépendant
            </label>
          </div>
