    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          ...
          <Text style={styles.name}>{`${user?.prenom || ''} ${user?.nom || ''}`.trim() || user?.denomination || 'Prestataire'}</Text>
          <Text style={styles.email}>{user?.email}</Text>
          
          <View style={styles.badgeRow}>
            <View style={styles.roleTag}>
              <Text style={styles.roleTagText}>Prestataire {user?.forfait_statut === 'actif' ? '• Premium' : ''}</Text>
            </View>
        ...
        <View style={styles.menuCardsContainer}>
          ...
          <TouchableOpacity style={styles.menuCard} onPress={() => setShowDetails(!showDetails)}>
            <View style={[styles.menuIconBox, { backgroundColor: '#FFF7ED' }]}>
              <Ionicons name="person-outline" size={22} color="#df6422" />
            </View>
            <View style={styles.menuTextContent}>
              <Text style={styles.menuTitle}>Informations Personnelles</Text>
              <Text style={styles.menuSubtitle}>Compétences, tarifs et coordonnées</Text>
            </View>
            ...
            <View style={styles.detailsBox}>
              <View style={styles.infoRow}>
                ...
                <View style={styles.infoContent}>
                  <Text style={styles.infoLabel}>Poste / Titre</Text>
                  <Text style={styles.infoValue}>{user?.poste || 'Non renseigné'}</Text>
                </View>
              </View>
              <View style={styles.infoRow}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoValue}>{user?.tarif_journalier ? `${user.tarif_journalier} €` : 'Non renseigné'}</Text>
                </View>
              </View>
              <View style={styles.infoRow}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoValue}>{Array.isArray(user?.competences) ? user.competences.join(', ') : (user?.competences || 'Aucune')}</Text>
                </View>
              </View>
              <View style={styles.infoRow}>
              ...
              <View style={styles.infoRow}>
                ...
                <View style={styles.infoContent}>
                  <Text style={styles.infoLabel}>Adresse / Ville</Text>
          ...
          <TouchableOpacity style={styles.menuCard} onPress={() => router.push('/freelancer/verification')}>
            ...
            <View style={styles.menuTextContent}>
              ...
              <Text style={styles.menuSubtitle}>Soumettre et suivre l'état de vérification</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#94A3B8" />
          </TouchableOpacity>

          {/* Card 3: Subscription Plan */}
          <TouchableOpacity style={styles.menuCard} onPress={() => router.push('/freelancer/forfait')}>
            ...
            <View style={styles.menuTextContent}>
              ...
              <Text style={styles.menuSubtitle}>Plan prestataire et limites de devis IA</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#94A3B8" />
          </TouchableOpacity>

          {/* Card 4: Support & Assistance */}
          <TouchableOpacity style={styles.menuCard} onPress={() => router.push('/freelancer/support' as any)}>
...
const styles = StyleSheet.create({
  ...
  avatarContainer: { width: 88, height: 88, borderRadius: 44, backgroundColor: '#FFF7ED', justifyContent: 'center', alignItems: 'center', marginBottom: 16, overflow: 'hidden', borderWidth: 2, borderColor: '#df6422' },
  avatarImage: { width: '100%', height: '100%' },
  avatarInitials: { fontSize: 32, fontWeight: '900', color: '#df6422' },
  ...
  roleTag: { backgroundColor: '#FFF7ED', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 12 },
  roleTagText: { color: '#df6422', fontSize: 12, fontWeight: '700' },
