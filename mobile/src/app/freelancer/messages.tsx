        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            <View style={styles.emptyIconBadge}>
              <Ionicons name="chatbubbles-outline" size={42} color="#df6422" />
            </View>
            <Text style={styles.emptyTitle}>Aucune conversation</Text>
            <Text style={styles.emptySubtitle}>
              Vos conversations et échanges de messages avec les employeurs s'afficheront ici.
            </Text>
...
const styles = StyleSheet.create({
  ...
  emptyIconBadge: {
    ...
    height: 88,
    borderRadius: 44,
    backgroundColor: 'rgba(223,100,34,0.1)',
    justifyContent: 'center',
    alignItems: 'center',
    marginBottom: 20,
    borderWidth: 1,
    borderColor: 'rgba(223,100,34,0.2)',
  },
