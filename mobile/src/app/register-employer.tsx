...
export default function RegisterEmployer() {
  ...
  const handleNextStep = () => {
    ...
    if (step === 1) {
      if (formData.numero_bce.length !== 10 && !manualMode) {
        setValidationError('Veuillez saisir un numéro BCE valide à 10 chiffres ou utiliser la saisie manuelle.');
        return;
      }
      ...
      if (manualMode && (!formData.denomination || !formData.adresse)) {
        setValidationError('Veuillez remplir la dénomination et l\'adresse du siège social.');
        return;
      }
    }
    ...
    if (step === 2) {
      if (!formData.prenom || !formData.nom || !formData.telephone) {
        setValidationError('Veuillez remplir votre prénom, nom et numéro de téléphone professionnel.');
        return;
      }
    }
    ...
    if (step === 4) {
      if (!formData.secteur) {
        setValidationError('Veuillez préciser le secteur d\'activité de votre entreprise.');
        return;
      }
    }
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.email || !formData.email.includes('@')) {
      setValidationError('Veuillez saisir une adresse email professionnelle valide.');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView 
          ...
          refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#082151" />}
        >
          <View style={styles.header}>
            <BackButton />
            <Text style={styles.headerTitle}>Inscription Recruteur</Text>
            <View style={{ width: 40 }} />
          </View>
          ...
          <View style={styles.formContainer}>
            {step === 1 && (
              <View style={styles.stepContent}>
                ...
                <View style={[
                  ...
                  />
                  {checkingBce && <ActivityIndicator size="small" color="#082151" />}
                ...
                {!bceVerified && !manualMode && !serviceUnavailable && (
                  ...
                  >
                    <Ionicons name="pencil-outline" size={16} color="#082151" />
                ...
                {(bceVerified || manualMode) && (
                  <>
                    ...
                    <View style={[styles.inputContainer, bceVerified && styles.readOnlyInput]}>
                      ...
                      <TextInput
                        style={styles.input}
                        placeholder="Ex: Construction & Batiment SRL"
                    ...
                    <View style={[styles.inputContainer, bceVerified && styles.readOnlyInput]}>
                      ...
                      <TextInput
                        style={styles.input}
                        placeholder="Ex: Avenue Louise 200, 1050 Bruxelles"
            ...
            {step === 4 && (
              <View style={styles.stepContent}>
                ...
                <Text style={styles.label}>Secteur d'activité principal</Text>
                <View style={styles.inputContainer}>
                  <Ionicons name="briefcase-outline" size={20} color="#94A3B8" style={styles.inputIcon} />
                  <TextInput
                    style={styles.input}
                    placeholder="Ex: Construction, Informatique, Restauration"
            ...
            {step === 5 && (
              <View style={styles.stepContent}>
                <Text style={styles.stepTitle}>Adresse Email Professionnelle</Text>
                <Text style={styles.label}>Email d'entreprise</Text>
                <View style={styles.inputContainer}>
...
const styles = StyleSheet.create({
  ...
  activeStepCircle: { backgroundColor: '#082151' },
  ...
  activeStepLabel: { color: '#082151', fontWeight: '700' },
  ...
  manualButtonPrimary: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#082151', paddingVertical: 12, borderRadius: 12, marginTop: 4 },
  ...
  manualLinkText: { fontSize: 13, fontWeight: '700', color: '#082151', textDecorationLine: 'underline' },
  ...
  primaryButton: { flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', backgroundColor: '#082151', paddingVertical: 16, borderRadius: 16, shadowColor: '#082151', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 8, elevation: 3 },
