...
export default function EmployerDevisDetail() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          ...
          <View style={styles.freelancerInfo}>
            ...
            <Text style={styles.freelancerText}>{devis.freelancer || devis.nom_prestataire || 'Prestataire'}</Text>
          </View>
      ...
      {/* Bouton pour actions futures (ex: Valider le devis, Refuser) */}
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  freelancerInfo: { flexDirection: 'row', alignItems: 'center', marginBottom: 24, gap: 8 },
  freelancerText: { fontSize: 16, color: '#64748B', fontWeight: '500' },
