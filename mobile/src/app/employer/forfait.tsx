    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          ...
          <Text style={styles.headerTitle}>Forfait Employeur</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          <View style={styles.planHeader}>
            ...
            <Text style={styles.planPrice}>49€<Text style={styles.planPricePeriod}>/mois</Text></Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color="#10B981" />
            <Text style={styles.featureText}>Publication de missions illimitée</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color="#10B981" />
            <Text style={styles.featureText}>Accès au top 5% des freelances</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="checkmark-circle" size={20} color="#10B981" />
          ...
          <TouchableOpacity style={styles.upgradeButton}>
            <Text style={styles.upgradeText}>Gérer l'abonnement</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
