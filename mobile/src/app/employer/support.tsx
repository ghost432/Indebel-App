...
export default function EmployerSupport() {
  ...
  const fetchTickets = useCallback(async () => {
    try {
      ...
      console.error('Erreur chargement tickets employer:', error);
      setTickets([]);
    } finally {
      setLoading(false);
      setRefreshing(false);
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              <View style={styles.emptyIconBadge}>
                <Ionicons name="headset-outline" size={42} color="#2b4eef" />
              </View>
...
const styles = StyleSheet.create({
  ...
  newTicketBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#2b4eef', justifyContent: 'center', alignItems: 'center' },
  ...
  statusBadgePending: { backgroundColor: '#EFF6FF' },
  statusText: { fontSize: 12, fontWeight: '700' },
  statusTextSuccess: { color: '#16A34A' },
  statusTextPending: { color: '#2563EB' },
  ...
  emptyIconBadge: { width: 88, height: 88, borderRadius: 44, backgroundColor: 'rgba(43,78,239,0.1)', justifyContent: 'center', alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: 'rgba(43,78,239,0.2)' },
  ...
  actionBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#2b4eef', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 14 },
  ...
  submitBtn: { backgroundColor: '#2b4eef', paddingVertical: 14, borderRadius: 14, alignItems: 'center' },
